...
class DealersControllerTest < ActionController::TestCase
  ...
  test "should create dealer" do
    assert_difference('Dealer.count') do
      post :create, dealer: { address: @dealer.address, creation_date: @dealer.creation_date, main_name: @dealer.main_name, name: @dealer.name, parent_id: @dealer.parent_id, status: @dealer.status }
    end
  ...
  test "should update dealer" do
    patch :update, id: @dealer, dealer: { address: @dealer.address, creation_date: @dealer.creation_date, main_name: @dealer.main_name, name: @dealer.name, parent_id: @dealer.parent_id, status: @dealer.status }
    assert_redirected_to dealer_path(assigns(:dealer))
  end
